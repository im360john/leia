...
const FILTER_FIELDS = {
  ...
  purchase: [
    ...
    { value: 'product_category', label: 'Product Category', type: 'select', icon: ShoppingCart, options: ['Electronics', 'Clothing', 'Home', 'Beauty', 'Sports'] },
    { value: 'payment_method', label: 'Payment Method', type: 'select', icon: DollarSign, options: ['Credit Card', 'PayPal', 'Apple Pay', 'Google Pay'] },
  ],
  engagement: [
